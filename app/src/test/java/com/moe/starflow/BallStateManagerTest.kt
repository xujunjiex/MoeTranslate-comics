...
class BallStateManagerTest {
    ...
    private fun frame(): android.widget.FrameLayout {
        ...
        fl.addView(android.widget.ImageView(ctx).apply {
            id = com.moe.starflow.R.id.floating_ball_icon
        })
        fl.addView(android.view.View(ctx).apply {
            id = com.moe.starflow.R.id.floating_ball_error_ring
        })
        return fl
    }
    ...
    @Test fun setErrorShowsRing() {
        ...
        val ring = fl.findViewById<android.view.View>(com.moe.starflow.R.id.floating_ball_error_ring)
