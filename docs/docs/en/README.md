...
config:
 -
   ...
   hero:
     name: StarFlow
     tagline: Game Translation + Manga Translation
     text: Android screenshot translation app
     actions:
       -
         theme: brand
         text: Docs
       ...
       -
         theme: alt
         text: Github
         link: https://github.com/xujunjiex/MoeTranslate-comics
 -
   type: features
   features:
     -
     ...
     -
       ...
       icon: 💬
       details: Bubble detection + OCR + translation + vertical text rendering
     -
       title: Multiple OCR Engines
       icon: ✨
       details: PP-OCRv5, ML Kit, manga-ocr supporting CJK languages
     -
       ...
       details: Support ML Kit and NLLB local models for complete offline translation
     -
       title: Rich Preset APIs
       icon: 🔗
       details: Pre-integrated with most translation APIs, just enter your key to use
     -
       title: Custom API Support
       icon: ♾️
       details: For advanced users, support custom API integration
---
