...
- 8种预置云端API：必应翻译、小牛翻译、聚合 AI 翻译、火山引擎、Azure翻译、DeepL翻译、百度翻译、腾讯云；
- 3个自定义云端文本翻译API预留位。
...
预置云端API有8种，分别是必应翻译、小牛翻译、聚合 AI 翻译、火山引擎、Azure翻译、DeepL翻译、百度翻译、腾讯云。其中只有必应翻译不需要配置API Key，其他的云端API均需配置API Key。
