<template>
    <div class="download-section">
      ...
      <div class="download-buttons">
        <button @click="handleDownload(0, 'https://www.123865.com/s/2f38Vv-rGOzH')" class="download-button pan-button">
        ...
        <button @click="handleDownload(2, 'https://repo.azuki.top/MoeTranslate_arm64-v8a_5.3.0.apk')" class="download-button local-button">
          <div class="button-content">
